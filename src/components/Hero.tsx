      ...
      <div className="w-full max-w-5xl mx-auto text-left flex flex-col items-start px-4 sm:px-0">
        ...
        <div className="mt-8 w-full text-left">
          ...
          <p className="text-base sm:text-lg font-medium text-white/50 tracking-wide">
            I&apos;m a Full-Stack Engineer with <span className="text-white">3.5+</span> years of experience building software in <span className="text-white">Java(Spring Boot)</span>, <span className="text-white">React</span>, <span className="text-white">Next.js</span>, <span className="text-white">Node</span>, <span className="text-white">MySQL</span>, <span className="text-white">DynamoDB &amp; Redis.</span> 
          </p>
        </div>
